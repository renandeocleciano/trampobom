...
import { ModulesRouterMapper, FeaturedModuleRouter } from '../../controllers/modules-router-map';
...
export class RouterModuleFactory {
    ...
    private createModules(registeredModule: FeaturedModuleRouter) : Array<ModuleEndPointMap>{
